...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingApp.API.Models.Geolocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DatingApp.API.Models.Visit", b =>
                {
            ...
            modelBuilder.Entity("DatingApp.API.Models.Geolocation", b =>
                {
                    b.HasOne("DatingApp.API.Models.User", null)
                        .WithOne("LastSavedGeolocation")
                        .HasForeignKey("DatingApp.API.Models.Geolocation", "UserId")
            ...
            modelBuilder.Entity("DatingApp.API.Models.Visit", b =>
                {
                    b.HasOne("DatingApp.API.Models.User", "Visited")
                        .WithMany("Visitors")
                        .HasForeignKey("VisitedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DatingApp.API.Models.User", "Visitor")
                        .WithMany("Visitees")
